...
class Quests(Enum):
    ...
    MAGIC_DUEL = (2, "Magic duel", 1, 15, 50, 0, [Item(ItemType.ACID, 1)], [], False, 0, 0, [], True, "Try your fortune and win in one duel")
    CHAMPION = (3, "Champion", 1, 20, 60, 10, [], [], True, 0, 0, [], True, "Buy any equipment and win all magic enemies")
